...
\begin{itemize}
	...
	\item We have introduced the function $F$ and $G$ in the statement of Proposition \ref{prop:dim_M_i's} to remove long inequalities. The beginning of the proof, about the basis of $\calR\left(g^{q^i-q^{i-1}+1}\right)$, has been also slightly modified. It is now more expansive. 
