\begin{tikzpicture}[scale=0.4]
	...
	\draw[style=help lines,dashed,opacity=0.3] (-6,-2) grid[step=1cm] (\largeur,\hauteur); % Draws a grid in the new coordinates.
	...
	\node at ($(0,0)!0.7!(E)+({\q*(\qO-2)},0)$) {$\calS^k_{(q_0-2,0)}$};
