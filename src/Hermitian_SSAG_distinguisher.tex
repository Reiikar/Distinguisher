...
\forall \: (f,g) \in \calL(F) \times \calL(G), \: \ev_{\calP}(f) \star \ev_{\calP}(f) = \ev_{\calP}(f\cdot g). 
\end{equation}
As a consequence, for associated AG codes, we have  $C_{\calL}(\calX,\mathcal{P},G)$
\[ C_{\calL}(\calX,\mathcal{P},F) \star C_{\calL}(\calX,\mathcal{P},F) \subseteq C_{\calL}(\calX,\calP,F+G).\]
