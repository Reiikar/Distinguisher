...
\begin{enumerate}
\item First, let $g_1 = x^4$. In this case, $g$ has 2 zeroes (say $P_1$ and $P_2$), which are those of $x$. More precisely, we have
