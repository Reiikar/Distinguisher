...
where $C_\text{Gauss}(n,k,q)$ is the cost of the Gauss-Jordan elimination of an $k\times n$ matrix over $\mathbb{F}_q$. We analysed the parameters of Goppa-like AG codes based on information set decoding attack,since it seems to have the lowest complexity.
