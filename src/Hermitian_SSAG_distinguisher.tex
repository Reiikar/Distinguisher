...
For a McEliece cryptosystem constructed on an $[n,k,t]_q$ linear code $\calC$, its public key has the size of $k(n-k)\lceil \log_2(q) \rceil$ if the generator matrix $G$ of $C$ is in its systematic form. 
