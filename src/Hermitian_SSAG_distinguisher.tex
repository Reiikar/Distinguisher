...
In our computing experiments, we can check that $g$ always has simple zeros. Thus $\left\lfloor \frac{sP_\infty+(g)}{3} \right\rfloor =-P_\infty$, meaning that we are outside the result of Proposition \ref{prop:non-eq}. As you can see, the bound is always sharp.
\end{expl}
