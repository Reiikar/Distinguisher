...
\TODO{def diviseur effectif + notation $D \geq 0$}



Let $\calX$ be a smooth and irreducible projective curve over $\fqm$ of genus.
Let $D \in \Div(\calX)$ be a divisor on $\calX$, whose Riemann-Roch space is defined as the $\fqm$ vector space
